...
{
	var unit_id     = "2769727";
	var client_ip   = "101.226.178.66";
	var server_time = "1407809322";
	var verify_code = "1b5795dc";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2769727/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
